...
:::definition "carlet-3-reed-muller-code" (parent := "carlet-chapter-3") (lean := "CryptBoolean.reedMuller, CryptBoolean.mem_reedMuller_iff, CryptBoolean.reedMuller_mono, CryptBoolean.affineFunction_mem_reedMuller_one, CryptBoolean.reedMuller_distance_pos") (uses := "carlet-2-def-algebraic-degree, carlet-2-support-degree-addition, carlet-2-def-hamming-distance, carlet-2-def-affine-functions") (tags := "carlet, chapter-3, reed-muller-code, pages-37-38, fidelity-exact-with-derived-laws")
...
:::theorem "carlet-3-theorem-1-order-one" (parent := "carlet-chapter-3") (lean := "CryptBoolean.hammingWeight_affineFunction_one_zero, CryptBoolean.two_pow_sub_one_le_hammingWeight_of_degree_le_one, CryptBoolean.reedMuller_one_distance_lower_bound") (uses := "carlet-3-reed-muller-code, carlet-2-def-affine-functions, carlet-3-affine-weight, carlet-2-support-degree-addition, carlet-2-def-hamming-distance") (tags := "carlet, chapter-3, theorem-1, order-one, fidelity-derived-specialization")
...
:::theorem "carlet-3-theorem-1" (parent := "carlet-chapter-3") (lean := "CryptBoolean.two_pow_sub_le_hammingWeight_of_degree_le, CryptBoolean.reedMuller_distance_lower_bound") (uses := "carlet-3-reed-muller-code, carlet-2-def-hamming-distance, carlet-2-anf-existence-uniqueness") (tags := "carlet, chapter-3, theorem-1, page-36, fidelity-exact")
