...
:::definition "carlet-2-pseudoboolean-fourier" (lean := "CryptBoolean.rawFourierTransform, CryptBoolean.rawFourierTransform_eq_two_pow_mul_vectorFourierCoeff") (uses := "carlet-2-def-boolean-function") (tags := "carlet, chapter-2, relation-11, page-21, fidelity-exact-with-normalization-bridge")
...
:::proposition "carlet-2-prop-6-fourier-shifts" (lean := "CryptBoolean.vectorFourierCoeff_mul_vectorWalshCharacter, CryptBoolean.rawFourierTransform_modulate_translate") (uses := "carlet-2-pseudoboolean-fourier") (tags := "carlet, chapter-2, proposition-6, page-24, fidelity-exact")
...
:::theorem "carlet-2-cor-2-fourier-involution" (lean := "CryptBoolean.rawFourierTransform_involution") (uses := "carlet-2-pseudoboolean-fourier") (tags := "carlet, chapter-2, corollary-2, relation-19, page-25, fidelity-exact")
...
:::proposition "carlet-2-prop-7-subspace-indicator" (lean := "CryptBoolean.two_pow_mul_inversePerpendicularCard_eq_card, CryptBoolean.rawFourierTransform_setIndicator_submodule") (uses := "carlet-2-pseudoboolean-fourier") (tags := "carlet, chapter-2, proposition-7, relation-16, pages-24-25, fidelity-exact")
...
:::corollary "carlet-2-poisson-normalized-specialization" (lean := "FABL.poissonSummationFormula") (uses := "carlet-2-prop-7-subspace-indicator, carlet-2-prop-6-fourier-shifts") (tags := "carlet, chapter-2, corollary-1, page-25, fidelity-normalized-specialization-direct-fabl")
...
:::corollary "carlet-2-cor-1-poisson-summation" (lean := "CryptBoolean.rawPoissonSummationFormula") (uses := "carlet-2-prop-6-fourier-shifts, carlet-2-prop-7-subspace-indicator") (tags := "carlet, chapter-2, corollary-1, relation-17, page-25, fidelity-exact")
...
:::definition "carlet-2-def-convolution" (lean := "CryptBoolean.rawConvolution, CryptBoolean.rawConvolution_eq_two_pow_mul_convolution") (tags := "carlet, chapter-2, page-26, fidelity-exact")
...
:::proposition "carlet-2-prop-8-convolution" (lean := "CryptBoolean.rawFourierTransform_rawConvolution") (uses := "carlet-2-def-convolution, carlet-2-pseudoboolean-fourier") (tags := "carlet, chapter-2, proposition-8, relation-20, page-26, fidelity-exact")
...
:::theorem "carlet-2-rel-22-plancherel" (lean := "CryptBoolean.sum_rawFourierTransform_mul") (uses := "carlet-2-prop-8-convolution, carlet-2-cor-2-fourier-involution") (tags := "carlet, chapter-2, relation-22, corollary-3, page-27, fidelity-exact-bilinear-form")
