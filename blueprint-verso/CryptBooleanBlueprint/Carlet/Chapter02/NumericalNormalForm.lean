...
:::proposition "carlet-2-prop-5-nnf-integrality" (lean := "CryptBoolean.IsIntegerValued, CryptBoolean.IsBooleanValued, CryptBoolean.numericalEval_integerValued_iff, CryptBoolean.numericalEval_booleanValued_iff_sum_sq_eq_sum") (uses := "carlet-2-prop-4-nnf-mobius") (tags := "carlet, chapter-2, proposition-5, page-21, fidelity-exact")
