...
:::proposition "carlet-2-prop-4-nnf-mobius" (parent := "carlet-chapter-2") (lean := "FABL.sum_Icc_neg_one_pow_card_sub, FABL.numericalMobiusCoeff, FABL.numericalEval_numericalMobiusCoeff_f₂CubeOfFinset, FABL.numericalMobiusCoeff_eq_numericalCoeff, FABL.numericalCoeff_eq_mobius_sum") (uses := "carlet-2-nnf-existence-uniqueness") (tags := "carlet, chapter-2, proposition-4, relation-8, page-19, fidelity-exact")
