...
:::definition "carlet-2-def-boolean-function" (lean := "CryptBoolean.BooleanFunction, CryptBoolean.realSignView") (tags := "carlet, chapter-2, pages-8-22, fidelity-exact")
...
:::definition "carlet-2-def-support-weight" (lean := "CryptBoolean.support, CryptBoolean.hammingWeight, CryptBoolean.mem_support, CryptBoolean.hammingWeight_eq_card_support") (uses := "carlet-2-def-boolean-function") (tags := "carlet, chapter-2, page-8, fidelity-exact-with-mathlib-hamming-norm")
...
:::definition "carlet-2-def-walsh-transform" (lean := "CryptBoolean.bitSignInt, CryptBoolean.walshTerm, CryptBoolean.walshTransform") (uses := "carlet-2-def-boolean-function") (tags := "carlet, chapter-2, pages-22-23, fidelity-exact")
