...
The binary extension field is [Mathlib](https://github.com/leanprover-community/mathlib4)'s $`\mathrm{GF}(2^n)`.  Its absolute trace is
...
polynomial of degree strictly below $`2^n`, obtained through [Mathlib](https://github.com/leanprover-community/mathlib4)'s finite
